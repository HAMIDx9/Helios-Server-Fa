...
SECRET_KEY = get_from_env('SECRET_KEY', '4646679')
...
DEFAULT_FROM_EMAIL = get_from_env('DEFAULT_FROM_EMAIL', 'me@hamidx9.ir')
DEFAULT_FROM_NAME = get_from_env('DEFAULT_FROM_NAME', 'Hamid Zamani')
...
# election stuff
SITE_TITLE = get_from_env('SITE_TITLE', 'رای‌گیری هلیوس')
...
WELCOME_MESSAGE = get_from_env('WELCOME_MESSAGE', "به سیستم راي‌گیری الکترونیکی هلیوس خوش آمدید!")

HELP_EMAIL_ADDRESS = get_from_env('HELP_EMAIL_ADDRESS', 'me@hamidx9.ir')
